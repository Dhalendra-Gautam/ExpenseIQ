...
import TimeFrameSelector from "../components/TimeFrame"; //changed name from TimeFrame to TimeFrameSelector
...
//small componant for income chart
...
//small component for filter section
...
const Income = () => {
    ...
    // function to check if date is in range or not
    ...
    //to export income data to excel
