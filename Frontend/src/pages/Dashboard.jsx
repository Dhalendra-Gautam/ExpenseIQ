...
const Dashboard = () => {
    ...
    const [showAllIncome, setShowAllIncome] = useState(false); //toggle button which show income
    ...
    const [newTransaction, setNewTransaction] = useState({
        ...
        description: "",
        amount: "",
        type: "expense", //or income based on toggle button
        category: "Food",
    });
    ...
    //function to check if the date of the transaction is in the range of the time frame
    ...
    //to filter the transactions based on the time and date
    ...
    }, [currentTimeFrameData, timeFrame]); //the graph will fill according to this data
    ...
    //to calculate the change in expense (in percent)
    ...
    const serverRecent = overviewMeta.recentTransactions || []; //recent list of transaction can be expense or income
    const serverRecentIncome = serverRecent
        .filter((t) => t.type === "income") //filter income
        .sort((a, b) => new Date(b.date) - new Date(a.date)); //sort by date
    const serverRecentExpense = serverRecent
        .filter((t) => t.type === "expense") //filter expense
